...
export const updateTransaction = createAction('[Family] Update Transaction', props<{ txId: string; request: UpdateFamilyTransactionRequest }>());
...
export const deleteTransaction = createAction('[Family] Delete Transaction', props<{ txId: string }>());
